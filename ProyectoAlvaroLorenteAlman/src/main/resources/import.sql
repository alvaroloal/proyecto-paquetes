...
('user', '1234', 'ROLE_CUSTOMER', 2),
('cliente1', 'cliente1', 'ROLE_CUSTOMER', 3),
('cliente2', 'cliente2', 'ROLE_CUSTOMER', 4),
('cliente3', 'cliente3', 'ROLE_CUSTOMER', 5),
('cliente4', 'cliente4', 'ROLE_CUSTOMER', 6);
...
(1, 2, 'CAJA', 5.0, 10.0, 15.0, 20.0, '2024-05-10', '2024-05-15', 1, 'PENDIENTE', 'ESTANDAR'),
(2, 3, 'SOBRE', 1.0, 2.0, 3.0, 4.0, '2024-05-11', '2024-05-16', 2, 'EN_TRANSITO', 'EXPRES'),
(3, 4, 'DOCUMENTO', 0.5, 1.0, 1.5, 2.0, '2024-05-12', '2024-05-17', 3, 'ENTREGADO', 'URGENTE'),
(4, 5, 'CAJA', 7.0, 12.0, 18.0, 25.0, '2024-05-13', '2024-05-18', 4, 'PENDIENTE', 'ESTANDAR'),
(5, 6, 'CAJA', 3.0, 8.0, 10.0, 15.0, '2024-05-14', '2024-05-19', 5, 'EN_TRANSITO', 'EXPRES');
